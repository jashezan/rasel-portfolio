...
import user from "../../data/developer.json";
...
const Contact = () => {
  ...
  const sendEmail = async (e) => {
    e.preventDefault();
    const formLink = "https://getform.io/f/acf2ba04-437d-464e-a629-bfea647dba3e";
    ...
    try {
      ...
      if (response.ok) {
        setSuccess(true);
        setError(false);
        // Clear the form by resetting input values to empty strings
